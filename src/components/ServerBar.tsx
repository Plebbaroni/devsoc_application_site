  ...
  return (
    <div className="ServerBarWrapper">
            <div className='ServerCircle'>
                <img src='../src/assets/discordlogo.png' className='discordicon'></img>
                <div className='PopOutTitleWrapper'>
                    <h4 className='PopOutTitle'>Home</h4>
                </div>
            </div>
            ...
            <div className='ServerCircle'>
                <div className='PopOutTitleWrapper'>
                    <h4 className='PopOutTitle'>Jared's Application</h4>
                </div>
            </div>
            <div className='ServerCircle util'>
                ...
                <div className='PopOutTitleWrapper'>
                    <h4 className='PopOutTitle'>Add New Server</h4>
                </div>
            </div>
            <div className='ServerCircle util'>
                ...
                <div className='PopOutTitleWrapper'>
                    <h4 className='PopOutTitle'>Explore Discoverable Servers</h4>
                </div>
            </div>
    </div>
  )
